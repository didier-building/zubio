export default {
  ...
  DOCS_URL: 'https://www.zubio.com/docs/product/',
  HELP_CENTER_DOCS_URL: 'https://www.zubio.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.zubio.com/content.json',
